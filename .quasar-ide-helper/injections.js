...
Vue.prototype.$q = {
  ...
  notify : {
     ...
     * @param {{type : String, color : String, textColor : String, message : String, caption : String, html : Boolean, icon : String, avatar : String, spinner : Boolean|Component, position : 'top-left'|'top-right'|'bottom-left'|'bottom-right'|'top'|'bottom'|'left'|'right'|'center', group : Boolean|String|Number, badgeColor : String, badgeTextColor : String, badgePosition : 'top-left'|'top-right'|'bottom-left'|'bottom-right', badgeStyle : Array|String|Object, badgeClass : Array|String|Object, progress : Boolean, progressClass : Array|String|Object, classes : String, attrs : Object, timeout : Number, actions : Array, onDismiss : Function, closeBtn : Boolean|String, multiLine : Boolean, ignoreDefaults : Boolean}|String} opts Notification options
    ...
    /**
     * Merge options into the default ones
     * @param {{type : String, color : String, textColor : String, message : String, caption : String, html : Boolean, icon : String, avatar : String, spinner : Boolean|Component, position : 'top-left'|'top-right'|'bottom-left'|'bottom-right'|'top'|'bottom'|'left'|'right'|'center', badgeColor : String, badgeTextColor : String, badgePosition : 'top-left'|'top-right'|'bottom-left'|'bottom-right', badgeStyle : Array|String|Object, badgeClass : Array|String|Object, progress : Boolean, progressClass : Array|String|Object, classes : String, attrs : Object, timeout : Number, actions : Array, onDismiss : Function, closeBtn : Boolean|String, multiLine : Boolean}} opts Notification options
     * @returns  
     */
    setDefaults (opts) {},
    /**
     ...
     * @param {{type : String, color : String, textColor : String, message : String, caption : String, html : Boolean, icon : String, avatar : String, spinner : Boolean|Component, position : 'top-left'|'top-right'|'bottom-left'|'bottom-right'|'top'|'bottom'|'left'|'right'|'center', badgeColor : String, badgeTextColor : String, badgePosition : 'top-left'|'top-right'|'bottom-left'|'bottom-right', badgeStyle : Array|String|Object, badgeClass : Array|String|Object, progress : Boolean, progressClass : Array|String|Object, classes : String, attrs : Object, timeout : Number, actions : Array, onDismiss : Function, closeBtn : Boolean|String, multiLine : Boolean}} typeOpts Notification options
     * @returns  
     */
