    ...
    <div>
      <div class="row">
        <div class="col">
          ...
          <Tablaprecal :info="get_listar_landin_result.resultado" />
        </div>
      </div>
    </div>
  </div>
...
export default {
  name: "Kardex",
  computed: {
    ...mapGetters("landing", ["get_listar_landin_result"]),
  },
  data() {
    return {
      cod_ope: "",
  ...
  components: {
    Tablaprecal: () => import("./Tablaprecaleev"),
  },
  methods: {
    ...mapActions("landing", ["call_listar_landin_result"]),
